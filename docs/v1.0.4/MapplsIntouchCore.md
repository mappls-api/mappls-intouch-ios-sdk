...
```
https://github.com/MapmyIndia/mappls-intouch-core-ios-distribution.git
```
...
| :---- | :---- | :---- |
| `1.0.4`| 23 Jul 2026  | Updated Mappls API Core|
| `1.0.3`| 27 Feb 2026  | Improvements|
...
`MapplsIntouchConfiguration` is a configuration class for managing and customising the behaviour of the Mappls InTouch Core SDK. It offers various location settings handles polling profiles and manages settings retrieved from device claims.  These properties are accessible via the `shared` property. 
